...
<main>
    <div class="rectangle">
        <div>
            <p id="pseudoname">Pseudo : <?php echo $user->getPseudo() ?></p>
        </div ><br>
        <div>
            <p id="AdresseMail">Mail : <?php echo $user->getEmail() ?></p>
        </div><br>
        <div>
            <p id="ProjetPub">Nombre de projets publiés : <?php echo $nbProjet ?></p>
        </div><br>
    </div>
